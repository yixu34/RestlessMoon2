...
function renderGeometry()
	...
	beginPass(0)
		renderObjectLayer("levelGeometry",cementFill1,cementFill2)
	endPass()
	...
	setVector("specularColor",0.5,0.5,0.5)
	beginPass(0)
		renderObjectLayer("levelGeometry",metalTwo,plastic)
	endPass()
	...
	beginPass(0)
		renderObjectLayer("levelGeometry",plating,shelfing)
	endPass()
