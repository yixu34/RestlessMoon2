...
isAI               = 1
staticEntity       = 0
weapon1            = "ToughSoldierWeapon" 
mesh               = "media/mdl_nme_soldier.x"
hitPoints          = 75
hitSound           = "media/sounds/soundFXCD/ScalyCreature_LowGrowl9.bbq"
deathSound	   = "media/sounds/soundFXCD/ScalyCreature_StuggleGrowl3.bbq"
